...
$(function () {
    ...
    */
    ...
    describe('RSS Feeds', function () {
        ...
        // Determines if allFeeds with a name and that the name is not empty 
    ...
    // New test suite that will test  menu
    describe('The Menu', function () {

        // Searches for the class  'menu-hidden' in the body tag.  true, then the menu is hidden 
        it('menu element is hidden', function () {
            expect($('body').hasClass('menu-hidden')).toEqual(true);
        });

        // Toggles on click when the menu appears or disappears
        it('working toggle on click event', function () {
            // Calls the class  'menu-icon-link' 
